...
export const ko: Messages = {
  ...
  auth: {
    entry: {
      eyebrow: '인증',
      heading: '계속하려면 로그인해 주세요',
      description: '처음 이용하는 경우 계정이 함께 만들어집니다.',
      resumeDescription: '선택한 기록 화면으로 이어집니다.',
      providerAction: 'OAuth로 계속하기',
      providerNeutralNotice: '사용할 인증 제공자는 아직 정해지지 않았습니다.',
      cancel: '검토 결과로 돌아가기',
      cancelEntry: '기록 유형 선택으로 돌아가기',
      cancelReviewStart: '검토 시작으로 돌아가기',
      loading: '로그인 정보를 확인하고 있어요',
      failure: '로그인하지 못했습니다',
      failureDescription: '잠시 후 다시 시도하거나 검토 결과로 돌아갈 수 있어요.',
      retry: '다시 시도',
      noIntent: '계속할 화면을 선택하면 원래 작업으로 돌아갈 수 있어요.',
      resumeNotice: '검토 결과를 이어서 작성할 수 있어요.',
      redirecting: '로그인 화면으로 이동하고 있어요.',
      unavailable: '인증 연결을 기다리고 있어요.',
      unavailableDescription: '현재 인증 연결이 준비되지 않아 다음 화면으로 이동하지 않습니다.',
    },
  },
  public: {
    home: { title: '공개 웹 홈' },
  ...
  app: {
    ...
    journalNew: {
      ...
      decisionContext: {
        title: '검토 맥락 함께 남기기',
        switchLabel: '검토 맥락 포함',
        enabledDescription: '이 판단을 내릴 때 참고한 검토 맥락도 함께 남깁니다.',
        disabledDescription: '이 판단에는 검토 맥락을 포함하지 않습니다.',
        ...
        immutableNotice:
          '질문, 체크리스트 버전, 확인 상태와 기록 시점을 당시 상태 그대로 남깁니다. AI 검토 결과 전체를 저장하지는 않습니다.',
      },
      form: {
        optional: '선택',
        checkEntries: '입력 확인',
        ...
        investment: {
          ...
          action: {
            label: '어떤 판단을 내렸나요?',
            helper: '추천이 아닌, 내가 내린 판단을 기록용으로 선택해주세요.',
          },
          reasoning: {
            label: '왜 그렇게 판단했나요?',
            placeholder: '이 시점에 이 행동을 한 이유를 적어보세요.',
            helper:
              '확인한 사실, 해석한 내용, 아직 모르는 점을 함께 적으면 나중에 판단을 복기하기 쉬워요.',
            count: '{{count}} / 4000',
          },
          emotion: {
            label: '판단 당시 상태는 어땠나요? (선택)',
            helper: '선택하지 않아도 됩니다. 당시 상태를 하나만 선택할 수 있어요.',
            none: '선택 안 함',
          },
        },
        study: {
          title: {
            ...
            helper: '이번에 배운 내용을 한 문장으로 적어보세요.',
          },
          occurredAt: {
            label: '기록 시점',
            helper: '시간대 변환 없이 입력한 현지 시각으로 기록합니다.',
          ...
          openQuestions: {
            label: '더 확인할 것',
            placeholder: '더 확인하고 싶은 질문을 적어보세요.',
            helper:
              '질문은 최대 10개, 각 500자까지 입력할 수 있어요. 같은 질문도 입력 순서대로 남습니다.',
            add: '질문 추가',
            remove: '질문 {{index}} 삭제',
            removeShort: '삭제',
            itemLabel: '확인할 질문 {{index}}',
            count: '{{count}} / 10',
          },
        },
      },
